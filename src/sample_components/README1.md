*For the Members*: You can add your sample files here. No restriction in the stack implementation, whether React.js or Vanilla(Normal) JS with HTML and CSS. Make sure the UI works.
